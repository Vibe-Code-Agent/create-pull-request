...
export class AppError extends Error {
    constructor(message, code, statusCode, isOperational = true, originalError) {
        super(message);
        this.code = code;
...
export class JiraAPIError extends AppError {
    constructor(message, ticketId, originalError) {
...
export class GitHubAPIError extends AppError {
    constructor(message, repoInfo, originalError) {
