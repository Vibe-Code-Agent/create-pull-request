 ...
 */
async function createOrUpdatePR(repo, finalTitle, finalBody, currentBranch, baseBranch, options, githubService, spinner) {
...
async function handlePRCreation(params) {
    ...
    const pullRequest = await createOrUpdatePR(repo, finalTitle, finalBody, currentBranch, baseBranch, options, githubService, spinner);
