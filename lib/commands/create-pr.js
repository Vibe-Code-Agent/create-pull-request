 ...
 */
async function handleJiraTicketInfo(jiraService, jiraTicket) {
 ...
 */
async function analyzeRepositoryChanges(gitService, githubService, baseBranch, currentBranch) {
 ...
 * Select PR template
 */
async function selectPRTemplate(githubService) {
...
export async function createPullRequest(options) {
    ...
    try {
        ...
        const jiraService = container.resolve(ServiceKeys.JIRA_SERVICE);
        const githubService = container.resolve(ServiceKeys.GITHUB_SERVICE);
        const gitService = container.resolve(ServiceKeys.GIT_SERVICE);
        const aiDescriptionService = container.resolve(ServiceKeys.AI_DESCRIPTION_SERVICE);
